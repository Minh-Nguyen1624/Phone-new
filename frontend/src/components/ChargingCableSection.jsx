...
import ChargingCableBanner from "./ChargingCableBanner";
import ChargingCableCategoryList from "./ChargingCableCategoryList";
import ChargingCableProductList from "./ChargingCableProductList";
import "../css/Accessory.css";

const ChargingCableSection = ({
  accessories,
  allAccessories,
  category,
  selectedFilter,
...
export default ChargingCableSection;
