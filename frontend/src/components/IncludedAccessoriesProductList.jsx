...
const IncludedAccessoriesProductList = ({
  accessories = [],
  soldQuantities = {},
}) => {
  console.log("IncludedAccessoriesProductList - accessories:", accessories); // Log chi tiết
...
export default IncludedAccessoriesProductList;
