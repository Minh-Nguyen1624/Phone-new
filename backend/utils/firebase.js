...
//   app,
//   firebaseConfig.storageBucket || "civic-rhythm-453818-h2.appspot.com"
// );
// console.log(
//   "Client SDK Storage initialized with bucket:",
//   firebaseConfig.storageBucket
// );

// // Initialize Firebase Admin SDK for Firestore
// const serviceAccount = require("../config/civic-rhythm-453818-h2-6e7567b429ac.json");
...
// // Upload file to Firebase Storage (Client SDK)
...
//     console.log("Uploading file to Firebase Storage with path:", filePath);
...
// // Get signed URL for a file (Client SDK)
...
// // Delete file from Firebase Storage (Client SDK)
...
// // Save message to Firestore (Admin SDK)
...
//     if (!message.isBot && !message.sender)
//       throw new Error("Message sender is missing for non-bot message");
...
//       sender: message.isBot ? null : message.sender.toString(),
//       readBy: message.readBy.map((id) => (id ? id.toString() : "")),
...
//     };
//     await db.collection("messages").doc(messageData._id).set(messageData);
//     console.log("Message saved to Firestore with kind:", messageData.kind);
//   } catch (error) {
...
// // Initialize Firebase Client SDK for Storage (optional, if needed elsewhere)
// const app = initializeFirebaseApp(firebaseConfig);
...
// const adminApp = adminInitializeApp({
//   credential: admin.credential.cert(serviceAccount),
//   // storageBucket: "civic-rhythm-453818-h2.appspot.com", // Đảm bảo bucket name chính xác
//   storageBucket: "civic-rhythm-453818-h2.firebasestorage.app", // Đảm bảo bucket name chính xác
// });
// const db = getFirestore(adminApp);
...
//     const timestamp = Date.now();
//     const sanitizedFileName = fileName.replace(/[^a-zA-Z0-9.-]/g, "_");
//     filePath = `chat-attachments/${timestamp}-${sanitizedFileName}`; // Cập nhật đường dẫn
...
//     await fileRef.save(buffer, { metadata, public: true });
//     console.log("File uploaded successfully to:", filePath);
...
//       expires: "03-09-2026",
//     });
//     console.log("Upload verified with URL:", url);
//     return { filePath, url };
//   } catch (error) {
//     if (
...
//     ) {
//       console.warn(
//         "Storage operation failed due to Spark Plan limitation. Falling back to Firestore."
//       );
//     }
//     console.error("Firebase Storage upload error:", {
//       message: error.message,
...
//       expires: "03-09-2026",
//     });
//     console.log("Signed URL generated for key:", key, "URL:", url);
//     return url;
//   } catch (error) {
...
//       _id: message._id.toString(),
//       conversation: message.conversation.toString(),
//       sender: message.isBot ? null : message.sender?.toString() || null,
//       readBy: message.readBy.map((id) => (id ? id.toString() : "")),
//       createdAt: message.createdAt
//         ? message.createdAt.toISOString()
//         : new Date().toISOString(),
...
//       kind: message.type || "text",
//       deleted: message.deleted || false,
//       attachmentBinary: message.attachmentBinary || null, // Store Base64 data
//       attachmentType: message.attachmentType || null, // Store file type
//     };
