...
// const createStripePaymentIntent = async (amount, currency, successUrl, cancelUrl) => {
//     try{
...
const createStripePaymentIntent = async (orderId, amount, currency, successUrl, cancelUrl) => {
    try {
        if (amount <= 0) {
