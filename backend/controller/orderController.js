...
//       (item) => !item.phoneId || !item.quantity || !item.price || !item.currency
//     );
//     if (invalidItem) {
//       return res
//         .status(400)
...
//     let discount = discountId;
//     console.log("Received discountId from client:", discountId);
...
//       if (!discountDoc) {
//         console.log(
//           `Error: Discount ID ${discountId} not found, setting to null`
//         );
//         return res
//           .status(400)
//           .json({ message: `Discount ID ${discountId} không tồn tại.` });
//       } else if (
...
//       ) {
//         console.log(
//           `Error: Discount ID ${discountId} is not active, setting to null`
//         );
//         return res
//           .status(400)
//           .json({ message: `Discount ID ${discountId} không hoạt động.` });
//       }
//     }
//     console.log("Assigned discount:", discount);
...
//       discount = cart.discount || discountId;
...
//           { _id: new mongoose.Types.ObjectId(item.phoneId) },
//           {
//             projection: {
//               stock: 1,
//               price: 1,
...
//       })),
//       subTotal: 0,
//       totalCartPrice: initialTotalCartPrice,
//       discount: discount,
//       discountAmount: 0,
//       shippingFee,
