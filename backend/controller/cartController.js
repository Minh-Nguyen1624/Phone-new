...
//       quantity,
//       // price,
//       // price: requestPrice, // Lấy price từ request để so sánh
//       imageUrl,
//       isGift,
//       customOption,
//       currency,
...
//       cart.items[existingItemIndex].quantity += quantity;
//       // cart.items[existingItemIndex].price = phone.finalPrice || phone.price; // Cập nhật giá từ Phone
//       // cart.items[existingItemIndex].price = price;
//     } else {
...
//       //   currency: currency || "VND", // Giá trị mặc định là VND nếu không có
//       // });
//       cart.items.push({
//         phone: phoneId,
//         quantity,
//         // price: price || phone.finalPrice || phone.price,
...
//     return res
//       .status(201)
//       .json({ message: "Product added to cart", cart: savedCart });
//   } catch (error) {
//     return res
//       .status(500)
